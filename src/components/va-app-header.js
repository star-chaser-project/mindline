  ...
  border: none;
    ...
    <div slot="label">  
      ...
      ${this.user.accessLevel == 1 ? html`
        ...
        <sl-drawer><a href="/products" @click="${this.menuClick}">Privacy</a><sl-drawer>
        <sl-drawer><a href="/products" @click="${this.menuClick}">T&Cs</a><sl-drawer>
        <sl-drawer><a href="/products" @click="${this.menuClick}">Socials</a><sl-drawer>
