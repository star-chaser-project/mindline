      ...
      <div class="page-content"> 
        ...
        <h3>Ways to deal with...</h3>
          <div class="button-group">
            ...
            <sl-button type="primary" size="large" @click=${() => gotoRoute('/MentalHealthExpanded')}>Anxiety</sl-button>
            <sl-button type="primary" size="large" @click=${() => gotoRoute('/MentalHealthExpanded')}>Depression</sl-button>
            </div>
       </section>
