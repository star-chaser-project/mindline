      ...
      <div class="page-content"> 
        ...
        <h3>Ways to deal with...</h3>
          <div class="button-group">
            <sl-button type="primary" size="large" @click=${() => gotoRoute('')}>Stress</sl-button>
            <sl-button type="primary" size="large" @click=${() => gotoRoute('')}>Anxiety</sl-button>
            <sl-button type="primary" size="large" @click=${() => gotoRoute('')}>Depression</sl-button>
            </div>
       </section>
