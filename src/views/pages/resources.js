    ...
    const template = html`
      ...
      <section class="nav-page">
        <h3>Ways to deal with...</h3>
          ...
          <sl-button type="primary" size="large" @click=${() => gotoRoute('/ResourcesExpanded')}>Support</sl-button>
          <sl-button type="primary" size="large" @click=${() => gotoRoute('/resourcesExpanded')}>Services</sl-button>
          <sl-button type="primary" size="large" @click=${() => gotoRoute('/resourcesExpanded')}>Guides</sl-button>
        </div>
      </section>
      </div>      
    `
