    ...
    const template = html`
      ...
      <section class="nav-page">
        <h3>Ways to deal with...</h3>
          ...
          <sl-button type="primary" size="large" @click=${() => gotoRoute('')}>Support</sl-button>
          <sl-button type="primary" size="large" @click=${() => gotoRoute('')}>Services</sl-button>
          <sl-button type="primary" size="large" @click=${() => gotoRoute('')}>Guides</sl-button>
        </div>
      </section>
      </div>      
    `
