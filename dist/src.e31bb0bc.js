...
class mentalHealthExpandedView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n      <va-app-header user=", ">\n      <a href=\"/\" @click=\"", "\"><img class=\"header-logo\" src=\"/images/logo-mindline-no-wording-white-125.svg\"></a>\n      </va-app-header>      \n      <div class=\"page-content\"> \n        <section class=\"banner mental-health\">\n        <img src=\"images/mental-health-hero-image.png\" class=\"responsive-img\" >    \n        <div class=\"banner-content\">     \n          <h1>Mental Health</h1>\n          <h2>Because it Matters</p>\n        </div>\n        </section>\n        <section class=\"nav-page\">\n        <h3>Ways to deal with...</h3>\n          <div class=\"button-group\">\n            <sl-button type=\"primary\" size=\"large\" @click=", ">Stress</sl-button>\n            <sl-button type=\"primary\" size=\"large\" @click=", ">Anxiety</sl-button>\n            <sl-button type=\"primary\" size=\"large\" @click=", ">Depression</sl-button>\n            </div>\n       </section>\n      \n      </div>  \n    "])), JSON.stringify(_Auth.default.currentUser), _Router.anchorRoute, () => (0, _Router.gotoRoute)(''), () => (0, _Router.gotoRoute)(''), () => (0, _Router.gotoRoute)(''));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
...
class resourcesView {
  ...
  render() {
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n       <va-app-header user=", ">\n           <a href=\"/\" @click=\"", "\"><img class=\"header-logo\" src=\"/images/logo-mindline-no-wording-white-125.svg\"></a>\n           </va-app-header>  \n      <div class=\"page-content\"> \n      <section class=\"banner resources\">\n        <img src=\"images/resources-hero-image-837.png\" class=\"responsive-img\" >    \n        <div class =\"banner-text\">      \n          <h1>Resources</h1>\n          <h2>Supporting You Every Step of the Way.</p>\n        </div>\n      </section>\n      <section class=\"nav-page\">\n        <h3>Ways to deal with...</h3>\n          <div class=\"button-group\">\n          <sl-button type=\"primary\" size=\"large\" @click=", ">Support</sl-button>\n          <sl-button type=\"primary\" size=\"large\" @click=", ">Services</sl-button>\n          <sl-button type=\"primary\" size=\"large\" @click=", ">Guides</sl-button>\n        </div>\n      </section>\n      </div>      \n    "])), JSON.stringify(_Auth.default.currentUser), _Router.anchorRoute, () => (0, _Router.gotoRoute)('/ResourcesExpanded'), () => (0, _Router.gotoRoute)('/resourcesExpanded'), () => (0, _Router.gotoRoute)('/resourcesExpanded'));
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
...
customElements.define('va-app-header', class AppHeader extends _litElement.LitElement {
  ...
  render() {
    return (0, _litElement.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n    <style>      \n      * {\n        box-sizing: border-box;\n      }\n      .app-header {\n        background: transparent;\n        position: fixed;\n        top: 0;\n        right: 0;\n        left: 0;\n        height: var(--app-header-height);\n        color: #fff;\n        display: flex;\n        z-index: 9;\n        box-shadow: 4px 0px 10px rgba(0,0,0,0.2);\n        align-items: center;\n      }\n      \n\n      .app-header-main {\n        flex-grow: 1;\n        display: flex;\n        align-items: center;\n      }\n\n      .app-header-main::slotted(h1){\n        color: #fff;\n      }\n\n      .app-logo a {\n        color: #fff;\n        text-decoration: none;\n        font-weight: bold;\n        font-size: 1.2em;\n        padding: .6em;\n        display: inline-block;        \n      }\n\n      .app-logo img {\n        width: 90px;\n      }\n      \n      .hamburger-btn::part(base) {\n        color: #fff;\n      }\n\n      .app-top-nav {\n        display: flex;\n        height: 100%;\n        align-items: center;\n      }\n\n      .app-top-nav a {\n        display: inline-block;\n        padding: .8em;\n        text-decoration: none;\n        color: #fff;\n      }\n      \n      .app-side-menu-items a {\n        display: block;\n        padding: 0.5em;\n        text-decoration: none;\n        font-size: 1.3em;\n        color: var(--app-header-txt-color);\n        padding-bottom: 0.5em;\n      }\n\n      .app-side-menu-logo {\n      width: 150px !important; \n        height: auto !important; /* Remove fixed height to maintain aspect ratio */\n        \n        top: 1em;\n      display: block;\n      \n    }\n\n      .page-title {\n        color: var(--app-header-txt-color);\n        margin-right: 0.5em;\n        font-size: var(--app-header-title-font-size);\n      }\n\n      /* active nav links */\n      .app-top-nav a.active,\n      .app-side-menu-items a.active {\n        font-weight: bold;\n      }\n\n      .menu-item::part(label) :hover {\n        color: #fff;\n      }\n\n\n  \n\n      sl-details::part(summary) {\n    transition: color 0.3s ease;\n  }\n\n  sl-details::part(summary):hover {\n    color: var(--sl-color-primary-600);\n    cursor: pointer;\n  }\n\n  .menu-expand {\n    transition: color 0.3s ease;\n    text-decoration: none;\n  }\n\n  .menu-expand:hover {\n    color: var(--sl-color-primary-600);\n    padding-left: 1.5em;\n    transition: all 0.5s ease;\n  }\n\n      /* right side menu */\n      .right-side-menu {\n        --base-txt-color: #2F1E1F;\n      }\n\n        .menu-expand {\n        font-size: 1.3em;\n        margin-left: 1em;\n        margin-top: 0.5em;\n      }\n\n      sl-drawer::part(label) {\n    padding: 0.6em;\n    \n    \n  }\n\n  sl-details::part(base) {\n  display: block;\n  border: none;\n  padding: 0.65em;\n}\n\nsl-details::part(content) {\n  border: none;\n  padding: 0;\n}\n\nsl-details::part(header) {\n  border: none;\n  padding: 0;\n}\n\nsl-details::part(summary) {\n  color: var(--sl-color-neutral-600);\n  font-size: 1.3em;\n  color: var(--app-header-txt-color);\n}\n\nsl-details::part(base) {\n  border: none;\n}\n\n\n      /* RESPONSIVE - MOBILE ------------------- */\n      @media all and (max-width: 768px){       \n        \n        .app-top-nav {\n          display: none;\n        }\n      }\n\n\n    </style>\n  \n    <header class=\"app-header\">\n      <sl-icon-button class=\"hamburger-btn\" name=\"list\" @click=\"", "\" style=\"font-size: 2em;\"></sl-icon-button>       \n      \n      <div class=\"app-header-main\">\n        ", "\n        <slot></slot>\n      </div>\n\n      <nav class=\"app-top-nav\">\n        \n        ", "\n        ", "\n        \n        <sl-dropdown>\n          <a slot=\"trigger\" href=\"#\" @click=\"", "\">\n            <sl-avatar style=\"--size: 40px;\" image=", "></sl-avatar> ", "\n          </a>\n          <sl-menu class=\"right-side-menu\">            \n            <sl-menu-item @click=\"", "\">Profile</sl-menu-item>\n            <sl-menu-item @click=\"", "\">Edit Profile</sl-menu-item>\n            <sl-menu-item @click=\"", "\">Sign Out</sl-menu-item>\n          </sl-menu>\n        </sl-dropdown>\n      </nav>\n    </header>\n\n    <sl-drawer class=\"app-side-menu\" placement=\"left\">\n    <div slot=\"label\">  \n      <a href=\"/\" @click=\"", "\"><img class=\"app-side-menu-logo\" src=\"/images/logo-mindline-trimmed-no-wording-clr.svg\"></a>      \n      </div>\n         \n      <nav class=\"app-side-menu-items\">\n      ", "\n        ", "\n       \n        \n        \n\n      </nav>  \n    </sl-drawer>\n    "])), this.hamburgerClick, this.title ? (0, _litElement.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n          <h1 class=\"page-title\">", "</h1>\n        "])), this.title) : "", this.user.accessLevel == 2 ? (0, _litElement.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["  \n          <a href=\"/newProduct\" @click=\"", "\">Add Bookmarks</a> \n          <a href=\"/orders\" @click=\"", "\">View Bookmarks</a>\n        "])), _Router.anchorRoute, _Router.anchorRoute) : '', this.user.accessLevel == 1 ? (0, _litElement.html)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n       \n          <a href=\"/about\" @click=\"", "\">About</a>       \n\n        "])), _Router.anchorRoute) : '', e => e.preventDefault(), this.user && this.user.avatar ? "".concat(_App.default.apiBase, "/images/").concat(this.user.avatar) : '', this.user && this.user.firstName, () => (0, _Router.gotoRoute)('/profile'), () => (0, _Router.gotoRoute)('/editProfile'), () => _Auth.default.signOut(), this.menuClick, this.user.accessLevel == 1 ? (0, _litElement.html)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n        <sl-details>\n                <div slot=\"summary\" class=\"summary-content\">\n                  <span class=\"summary-title\" @click=\"", "\">Mental Health</span>\n                </div>\n                  <a class=\"menu-expand\" href=\"\">Stress</a>\n                  <a class=\"menu-expand\" href=\"\">Anxiety</a>\n                  <a class=\"menu-expand\" href=\"\">Depression</a>\n              </sl-details>\n              <sl-details>\n                <div slot=\"summary\" class=\"summary-content\">\n                  <span class=\"summary-title\" @click=\"", "\">Mindfulness</span>\n                </div>\n                  <a class=\"menu-expand\" href=\"\">Meditation</a>\n                  <a class=\"menu-expand\" href=\"\">Breathing</a>\n                  <a class=\"menu-expand\" href=\"\">Motivation</a>\n              </sl-details>\n              <sl-details>\n                <div slot=\"summary\" class=\"summary-content\">\n                  <span class=\"summary-title\" @click=\"", "\">Resources</span>\n                </div>\n                  <a class=\"menu-expand\" href=\"\">Support</a>\n                  <a class=\"menu-expand\" href=\"\">Services</a>\n                  <a class=\"menu-expand\" href=\"\">Guides</a>\n              </sl-details>\n        <a href=\"/favouriteLines\" @click=\"", "\">Bookmarks</a>\n        <a href=\"/about\" @click=\"", "\">About</a>\n        \n        <a href=\"/profile\" @click=\"", "\">Profile</a>   \n         <a href=\"/favouriteLines\" @click=\"", "\">Bookmarks</a>\n        <hr style=\"color: #fff width:10%\" >\n\n        <sl-drawer><a href=\"/products\" @click=\"", "\">Privacy</a><sl-drawer>\n        <sl-drawer><a href=\"/products\" @click=\"", "\">T&Cs</a><sl-drawer>\n        <sl-drawer><a href=\"/products\" @click=\"", "\">Socials</a><sl-drawer>\n\n        <hr style=\"color: #fff width:10%\" >\n\n        <a href=\"mailto:hello@mindline.telstra.com.au\">hello@mindline.telstra.com.au</a>\n        <a href=\"tel:1800 034 034\">1800 034 034</a>\n\n        "])), e => this.handleTitleClick('/mentalHealth', e), e => this.handleTitleClick('/mindfulness', e), e => this.handleTitleClick('/resources', e), this.menuClick, this.menuClick, this.menuClick, this.menuClick, this.menuClick, this.menuClick, this.menuClick) : '', this.user.accessLevel == 2 ? (0, _litElement.html)(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n        \n        <sl-details>\n                <div slot=\"summary\" class=\"summary-content\">\n                  <span class=\"summary-title\" @click=\"", "\">Mental Health</span>\n                </div>\n                  <a class=\"menu-expand\" href=\"/mentalHealthExpanded\">Stress</a>\n                  <a class=\"menu-expand\" href=\"mentalHealthExpanded\">Anxiety</a>\n                  <a class=\"menu-expand\" href=\"mentalHealthExpanded\">Depression</a>\n              </sl-details>\n              <sl-details>\n                <div slot=\"summary\" class=\"summary-content\">\n                  <span class=\"summary-title\" @click=\"", "\">Mindfulness</span>\n                </div>\n                  <a class=\"menu-expand\" href=\"mindfulnessExpanded\">Meditation</a>\n                  <a class=\"menu-expand\" href=\"mindfulnessExpanded\">Breathing</a>\n                  <a class=\"menu-expand\" href=\"mindfulnessExpanded\">Motivation</a>\n              </sl-details>\n              <sl-details>\n                <div slot=\"summary\" class=\"summary-content\">\n                  <span class=\"summary-title\" @click=\"", "\">Resources</span>\n                </div>\n                  <a class=\"menu-expand\" href=\"/resourcesExpanded\">Support</a>\n                  <a class=\"menu-expand\" href=\"/resourcesExpanded\">Services</a>\n                  <a class=\"menu-expand\" href=\"/resourcesExpanded\">Guides</a>\n              </sl-details>\n        <a href=\"/favouriteLines\" @click=\"", "\">Bookmarks</a>\n        <a href=\"/about\" @click=\"", "\">About</a>\n        <a href=\"/profile\" @click=\"", "\">Profile</a>\n        <a href=\"/favouriteLines\" @click=\"", "\">Bookmarks</a>\n\n        <hr style=\"color: #fff width:10%\" >\n\n        <a href=\"/products\" @click=\"", "\">Privacy</a>\n        <a href=\"/products\" @click=\"", "\">T&Cs</a>\n        <a href=\"/products\" @click=\"", "\">Socials</a>\n\n        <hr style=\"color: #fff width:10%\" >\n\n        <a href=\"mailto:hello@mindline.telstra.com.au\">hello@mindline.telstra.com.au</a>\n        <a href=\"tel:1800 034 034\">1800 034 034</a>\n\n        "])), e => this.handleTitleClick('/mentalHealth', e), e => this.handleTitleClick('/mindfulness', e), e => this.handleTitleClick('/resources', e), this.menuClick, this.menuClick, this.menuClick, this.menuClick, this.menuClick, this.menuClick, this.menuClick) : '');
  }
});
