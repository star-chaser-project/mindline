    ...
    const template = html`
      ...
      <section class="nav-page">
        <h3>Ways to deal with...</h3>
          ...
          <sl-button class="support" @click=${() => gotoRoute('/resourcesExpanded?tab=support')}>Support</sl-button>
          <sl-button class="services" @click=${() => gotoRoute('/resourcesExpanded?tab=services')}>Services</sl-button>
          <sl-button class="guides" @click=${() => gotoRoute('/resourcesExpanded?tab=guides')}>Guides</sl-button>
        </div>
      </section>
      </div>      
    `
