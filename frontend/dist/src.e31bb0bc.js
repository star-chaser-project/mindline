...
class mentalHealthExpandedView {
  ...
  render() {
    ...
    const template = (0, _litHtml.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n    <style>\n      .banner.mental-health-expanded {\n      height: 100vh; \n      background-color: #6686E3;\n      /*padding-top: 15%;*/\n    }\n\n    .banner-content {\n      height: 80%;\n      width: 60%;\n    }\n\n    sl-tab-group::part(base) {\n      display: flex;\n      align-items: center;\n      gap: 32px;\n    \n    }\n\n  \n    sl-tab-group::part(nav) {\n    border-bottom: none;\n  }\n\n  sl-tab-group::part(active-tab-indicator) {\n    display: none !important;\n    opacity: 0;\n    visibility: hidden;\n  }\n\n  sl-tab-group::part(tabs) {\n    border-bottom: none;\n  }\n\n  sl-tab::part(base) {\n    border-bottom: none;\n    margin: 0 12px;\n    padding: 12px 24px;\n    font-size: 18px;\n  font-weight: 500;\n  transition: all 0.2s ease;\n  }\n\n  sl-tab:not([active])::part(base):hover {\n  font-size: 20px;\n}\n\nsl-tab[active]::part(base) {\n  font-size: 20px;\n  color: #F3C728 !important;\n}\n\n    #bento-tabs {\n      width: 100%;\n      display: flex;\n      justify-content: center;\n      align-items: left;\n    }\n    \n    h1 {\n      margin-bottom: 50px !important;\n      width: 50% !important;\n      margin-left: 13% !important;\n    }\n    \n\n    .why {\n      grid-area: why;\n      width: 193px;\n      height: 193px;\n      border-radius: 35px;\n      background-color: #FFFFFF;\n      position: relative;\n      display: flex;\n      overflow: hidden;\n      cursor: pointer;\n    }\n    \n    .deal {\n      grid-area: deal;\n      width: 361px;\n      height: 193px;\n      border-radius: 35px;\n      background-color: #FFFFFF;\n      position: relative;\n      display: flex;\n      overflow: hidden;\n      cursor: pointer;\n    }\n    \n    .signs {\n      grid-area: signs;\n      width: 193px;\n      height: 411px;\n      border-radius: 35px;\n      background-color: #FFFFFF;\n      position: relative;\n      display: flex;\n      overflow: hidden;\n      cursor: pointer;\n    }\n    \n    .triggers {\n      grid-area: triggers;\n      width: 361px;\n      height: 193px;\n      border-radius: 35px;\n      background-color: #FFFFFF;\n      position: relative;\n      display: flex;\n      overflow: hidden;\n      cursor: pointer;\n    }\n    \n    .practices {\n      grid-area: practices;\n      width: 193px;\n      height: 411px;\n      border-radius: 35px;\n      background-color: #FFFFFF;\n      margin-left: 168px;\n      position: relative;\n      display: flex;\n      overflow: hidden;\n      cursor: pointer;\n    }\n    \n    .seek {\n      grid-area: seek;\n      width: 361px;\n      height: 193px;\n      border-radius: 35px;\n      background-color: #FFFFFF;\n      position: relative;\n      display: flex;\n      overflow: hidden;\n      cursor: pointer;\n    }\n    \n    .questions {\n      grid-area: questions;\n      width: 193px;\n      height: 193px;\n      border-radius: 35px;\n      background-color: #FFFFFF;\n      margin-left: 385px;\n      position: relative;\n      display: flex;\n      overflow: hidden;\n      cursor: pointer;\n    }\n\n.stress {\n  display: grid;\n  grid-template-areas: \n    \"why deal signs\"\n    \"triggers practices practices\"\n    \"seek questions questions\";\n  grid-template-columns: 193px 361px 193px; /* Explicit column widths */\n  grid-template-rows: 193px 193px 193px; /* Fixed row heights */\n  gap: 24px; /* Minimal gap */\n  align-items: start; /* Align items to top */\n  margin-top: 8px;\n}\n\n\n    p {\n      color: #000000;\n    }\n\n    .bookmark, .bookmark-full {\n    position: absolute;\n    width: auto;\n    height: 30px;\n    top: -0.5px;\n    right: 35px;\n    filter: drop-shadow(2px 2px 2px rgba(0, 0, 0, 0.3));\n  }\n    \n\n  sl-dialog::part(base) {\n    color: #000000;\n  }\n\n  sl-dialog::part(overlay) {\n    backdrop-filter: blur(8px);\n    background-color: rgba(0, 0, 0, 0.5);\n  }\n\n\n  sl-dialog::part(panel) {\n    border-radius: 35px;\n    z-index: 1000;\n  }\n\n  sl-dialog::part(close-button) {\n    display: none;\n  }\n\n    .why-img {\n      width: 400px; /* Much larger than parent */\n      height: 400px; /* Much larger than parent */\n      position: absolute;\n      z-index: 0;\n      object-fit: cover;\n      transform: translate(-50%, -50%);\n      top: 60%;\n      left: 60%;\n      border-radius: 35px;\n      transition: transform 0.3s ease;\n    }\n\n    .why:hover .why-img {\n      transform: translate(-50%, -50%) scale(1.1);\n    }\n\n    .why p {\n      width: 30%;\n      font-size: 20px;\n      font-weight: 300;\n      margin-left: 10%;\n      z-index: 1;\n    }\n\n    </style>\n\n    \n\n    ", "\n      <a href=\"/\" @click=\"", "\"><img class=\"header-logo\" src=\"/images/logo/logo-mindline-no-wording-white-125.png\"></a>      \n      <div class=\"page-content\"> \n        <section class=\"banner mental-health-expanded\">\n        \n        <div class=\"banner-content\">     \n          <h1>Mental Health</h1>\n          <div id=\"bento-tabs\">\n            <sl-tab-group ?active=\"", "\">\n              <sl-tab slot=\"nav\" panel=\"stress\" ?active=\"", "\">Stress</sl-tab>\n              <sl-tab slot=\"nav\" panel=\"anxiety\" ?active=\"", "\">Anxiety</sl-tab>\n              <sl-tab slot=\"nav\" panel=\"depression\" ?active=\"", "\">Depression</sl-tab>\n\n              <!-- this is the first tab content of the menal health page -->\n              <sl-tab-panel name=\"stress\">\n                \n       \n                <div class=\"stress\">\n                \n                  <div class=\"why why-stress\" @click=", ">\n                    <img src=\"/images/mental-health/stress/stress-why-mental-health-matters-360.webp\" class=\"why-img\">\n                    <p>", "</p>\n                    <img src=\"/images/bookmark/bookmark-4.svg\" class=\"bookmark\">\n                    <sl-dialog label=\"", "\" class=\"dialog-width\" style=\"--width: 50vw; --height: 60vh;\">\n                      ", "\n                      <sl-button slot=\"footer\" variant=\"primary\" \n                        @click=", ">Bookmark</sl-button>\n                      <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Close</sl-button>\n                    </sl-dialog>\n                  </div>\n\n                  <div class=\"deal deal-stress\" @click=", ">\n                    <img src=\"/images/stress-box.png\" class=\"stress-img\">\n                    <p>", "</p>\n                    <img src=\"/images/bookmark/bookmark-full.svg\" class=\"bookmark\">\n                    <sl-dialog label=\"", "\" class=\"dialog-width\" style=\"--width: 50vw; --height: 60vh;\">\n                    ", "\n                      <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Bookmark</sl-button>\n                      <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Close</sl-button>\n                  </div>\n\n                  <div class=\"signs signs-stress\" @click=", ">\n                    <img src=\"/images/signs-box.png\" class=\"signs-img\">\n                    <p>", "</p>\n                    <img src=\"/images/bookmark/bookmark-4.svg\" class=\"bookmark\">\n                    <sl-dialog label=\"", "\" class=\"dialog-width\" style=\"--width: 50vw; --height: 60vh;\">\n                    ", "\n                    <sl-button slot=\"footer\" variant=\"primary\" \n                    @click=", ">Bookmark</sl-button>\n                    \n                    <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Close</sl-button>\n                  </div>\n                \n                \n                  <div class=\"triggers triggers-stress\" @click=", ">\n                    <img src=\"/images/triggers-box.png\" class=\"triggers-img\">\n                    <p>", "</p>\n                    <img src=\"/images/bookmark/bookmark-4.svg\" class=\"bookmark\">\n                    <sl-dialog label=\"", "\" class=\"dialog-width\" style=\"--width: 50vw; --height: 60vh;\">\n                    ", "\n                    <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Bookmark</sl-button>\n                    <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Close</sl-button>\n                  </div>\n\n                  <div class=\"practices practices-stress\" @click=", ">\n                    <img src=\"/images/practices-box.png\" class=\"practices-img\">\n                      <p>", "</p>\n                    <img src=\"/images/bookmark/bookmark-4.svg\" class=\"bookmark\">\n                    <sl-dialog label=\"", "\" class=\"dialog-width\" style=\"--width: 50vw; --height: 60vh;\">\n                    ", "\n                    <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Bookmark</sl-button>\n                    <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Close</sl-button>\n                  </div>\n                \n                  <div class=\"seek seek-stress\" @click=", ">\n                  <img src=\"/images/seek-box.png\" class=\"seek-img\">\n                 <p>", "</p>\n                    <img src=\"/images/bookmark/bookmark-4.svg\" class=\"bookmark\">\n                    <sl-dialog label=\"", "\" class=\"dialog-width\" style=\"--width: 50vw; --height: 60vh;\">\n                    ", "\n                    <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Bookmark</sl-button>\n                    <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Close</sl-button>\n                  </div>\n\n                  <div class=\"questions\" @click=", ">\n                  <img src=\"/images/questions-box.png\" class=\"questions-img\">\n                      <p>", "</p>\n                    <img src=\"/images/bookmark/bookmark-4.svg\" class=\"bookmark\">\n                    <sl-dialog label=\"", "\" class=\"dialog-width\" style=\"--width: 50vw; --height: 60vh;\">\n                    ", "\n                    <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Bookmark</sl-button>\n                    <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Close</sl-button>\n                  </div>\n                </div>\n\n\n\n              </sl-tab-panel>\n\n               <!-- this is the second tab content of the mental health page -->\n              <sl-tab-panel name=\"anxiety\">\n                <div class=\"stress\">\n                \n                  <div class=\"why why-anxiety\" @click=", ">\n                    <img src=\"/images/\" class=\"why-img\">\n                    <p>", "</p>\n                    <img src=\"/images/bookmark/bookmark-4.svg\" class=\"bookmark\">\n                    <sl-dialog label=\"", "\" class=\"dialog-width\" style=\"--width: 50vw; --height: 60vh;\">\n                      ", "\n                      <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Bookmark</sl-button>\n                      <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Close</sl-button>\n                    </sl-dialog>\n                  </div>\n\n                  <div class=\"deal deal-anxiety\" @click=", ">\n                    <img src=\"/images/\" class=\"stress-img\">\n                    <p>", "</p>\n                    <img src=\"/images/bookmark/bookmark-full.svg\" class=\"bookmark\">\n                    <sl-dialog label=\"", "\" class=\"dialog-width\" style=\"--width: 50vw; --height: 60vh;\">\n                    ", "\n                      <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Bookmark</sl-button>\n                      <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Close</sl-button>\n                  </div>\n\n                  <div class=\"signs signs-anxiety\" @click=", ">\n                    <img src=\"/images/\" class=\"signs-img\">\n                    <p>", "</p>\n                    <img src=\"/images/bookmark/bookmark-4.svg\" class=\"bookmark\">\n                    <sl-dialog label=\"", "\" class=\"dialog-width\" style=\"--width: 50vw; --height: 60vh;\">\n                    ", "\n                    <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Bookmark</sl-button>\n                    <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Close</sl-button>\n                  </div>\n                \n                \n                  <div class=\"triggers triggers-anxiety\" @click=", ">\n                    <img src=\"/images/\" class=\"triggers-img\">\n                    <p>", "</p>\n                    <img src=\"/images/bookmark/bookmark-4.svg\" class=\"bookmark\">\n                    <sl-dialog label=\"", "\" class=\"dialog-width\" style=\"--width: 50vw; --height: 60vh;\">\n                    ", "\n                    <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Bookmark</sl-button>\n                    <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Close</sl-button>\n                  </div>\n\n                  <div class=\"practices practices-anxiety\" @click=", ">\n                    <img src=\"/images/\" class=\"practices-img\">\n                      <p>", "</p>\n                    <img src=\"/images/bookmark/bookmark-4.svg\" class=\"bookmark\">\n                    <sl-dialog label=\"", "\" class=\"dialog-width\" style=\"--width: 50vw; --height: 60vh;\">\n                    ", "\n                    <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Bookmark</sl-button>\n                    <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Close</sl-button>\n                  </div>\n                \n                  <div class=\"seek seek-anxiety\" @click=", ">\n                  <img src=\"/images/\" class=\"seek-img\">\n                 <p>", "</p>\n                    <img src=\"/images/bookmark/bookmark-4.svg\" class=\"bookmark\">\n                    <sl-dialog label=\"", "\" class=\"dialog-width\" style=\"--width: 50vw; --height: 60vh;\">\n                    ", "\n                    <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Bookmark</sl-button>\n                    <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Close</sl-button>\n                  </div>\n\n                  <div class=\"questions questions-anxiety\" @click=", ">\n                  <img src=\"/images/\" class=\"questions-img\">\n                      <p>", "</p>\n                    <img src=\"/images/bookmark/bookmark-4.svg\" class=\"bookmark\">\n                    <sl-dialog label=\"", "\" class=\"dialog-width\" style=\"--width: 50vw; --height: 60vh;\">\n                    ", "\n                    <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Bookmark</sl-button>\n                    <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Close</sl-button>\n                  </div>\n                </div>\n              </sl-tab-panel>\n\n               <!-- this is the third tab content of the menal health page -->\n              <sl-tab-panel name=\"depression\">\n                <div class=\"stress\">\n                \n                  <div class=\"why\" @click=", ">\n                    <img src=\"/images/why-box.png\" class=\"why-img\">\n                    <p>", "</p>\n                    <img src=\"/images/bookmark/bookmark-4.svg\" class=\"bookmark\">\n                    <sl-dialog label=\"", "\" class=\"dialog-width\" style=\"--width: 50vw; --height: 60vh;\">\n                      ", "\n                      <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Bookmark</sl-button>\n                      <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Close</sl-button>\n                    </sl-dialog>\n                  </div>\n\n                  <div class=\"deal\" @click=", ">\n                    <img src=\"/images/stress-box.png\" class=\"stress-img\">\n                    <p>", "</p>\n                    <img src=\"/images/bookmark/bookmark-full.svg\" class=\"bookmark\">\n                    <sl-dialog label=\"", "\" class=\"dialog-width\" style=\"--width: 50vw; --height: 60vh;\">\n                    ", "\n                      <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Bookmark</sl-button>\n                      <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Close</sl-button>\n                  </div>\n\n                  <div class=\"signs\" @click=", ">\n                    <img src=\"/images/signs-box.png\" class=\"signs-img\">\n                    <p>", "</p>\n                    <img src=\"/images/bookmark/bookmark-4.svg\" class=\"bookmark\">\n                    <sl-dialog label=\"", "\" class=\"dialog-width\" style=\"--width: 50vw; --height: 60vh;\">\n                    ", "\n                    <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Bookmark</sl-button>\n                    <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Close</sl-button>\n                  </div>\n                \n                \n                  <div class=\"triggers\" @click=", ">\n                    <img src=\"/images/triggers-box.png\" class=\"triggers-img\">\n                    <p>", "</p>\n                    <img src=\"/images/bookmark/bookmark-4.svg\" class=\"bookmark\">\n                    <sl-dialog label=\"", "\" class=\"dialog-width\" style=\"--width: 50vw; --height: 60vh;\">\n                    ", "\n                    <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Bookmark</sl-button>\n                    <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Close</sl-button>\n                  </div>\n\n                  <div class=\"practices\" @click=", ">\n                    <img src=\"/images/practices-box.png\" class=\"practices-img\">\n                      <p>", "</p>\n                    <img src=\"/images/bookmark/bookmark-4.svg\" class=\"bookmark\">\n                    <sl-dialog label=\"", "\" class=\"dialog-width\" style=\"--width: 50vw; --height: 60vh;\">\n                    ", "\n                    <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Bookmark</sl-button>\n                    <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Close</sl-button>\n                  </div>\n                \n                  <div class=\"seek\" @click=", ">\n                  <img src=\"/images/seek-box.png\" class=\"seek-img\">\n                 <p>", "</p>\n                    <img src=\"/images/bookmark/bookmark-4.svg\" class=\"bookmark\">\n                    <sl-dialog label=\"", "\" class=\"dialog-width\" style=\"--width: 50vw; --height: 60vh;\">\n                    ", "\n                    <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Bookmark</sl-button>\n                    <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Close</sl-button>\n                  </div>\n\n                  <div class=\"questions_depression\" @click=", ">\n                  <img src=\"/images/questions-box.png\" class=\"questions-img\">\n                      <p>", "</p>\n                    <img src=\"/images/bookmark/bookmark-4.svg\" class=\"bookmark\">\n                    <sl-dialog label=\"", "\" class=\"dialog-width\" style=\"--width: 50vw; --height: 60vh;\">\n                    ", "\n                    <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Bookmark</sl-button>\n                    <sl-button slot=\"footer\" variant=\"primary\" @click=", ">Close</sl-button>\n                  </div>\n                </div>\n              </sl-tab-panel>\n\n            </sl-tab-group>\n          </div>\n        </div>\n        </section>\n          \n      \n      </div>  \n    "])), _Auth.default.isLoggedIn() ? (0, _litHtml.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["<va-app-header user=", "></va-app-header>"])), JSON.stringify(_Auth.default.currentUser)) : (0, _litHtml.html)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["<va-public-header></va-public-header>"]))), _Router.anchorRoute, activeTab, activeTab === 'stress', activeTab === 'anxiety', activeTab === 'depression', this.openDialog, ((_this$articles$get = this.articles.get('why')) === null || _this$articles$get === void 0 ? void 0 : _this$articles$get.title) || 'Loading...', (_this$articles$get2 = this.articles.get('why')) === null || _this$articles$get2 === void 0 ? void 0 : _this$articles$get2.title, ((_this$articles$get3 = this.articles.get('why')) === null || _this$articles$get3 === void 0 ? void 0 : _this$articles$get3.bodyContent) || 'Loading content...', e => {
      ...
      console.log("Bookmarking article ID:", articleId);
      this.bookmarkArticle(e, articleId);
    }, this.closeDialog, this.openDialog, ((_this$articles$get12 = this.articles.get('triggers')) === null || _this$articles$get12 === void 0 ? void 0 : _this$articles$get12.title) || 'Loading...', (_this$articles$get13 = this.articles.get('triggers')) === null || _this$articles$get13 === void 0 ? void 0 : _this$articles$get13.title, ((_this$articles$get14 = this.articles.get('triggers')) === null || _this$articles$get14 === void 0 ? void 0 : _this$articles$get14.bodyContent) || 'Loading content...', this.closeDialog, this.closeDialog, this.openDialog, ((_this$articles$get15 = this.articles.get('practices')) === null || _this$articles$get15 === void 0 ? void 0 : _this$articles$get15.title) || 'Loading...', (_this$articles$get16 = this.articles.get('practices')) === null || _this$articles$get16 === void 0 ? void 0 : _this$articles$get16.title, ((_this$articles$get17 = this.articles.get('practices')) === null || _this$articles$get17 === void 0 ? void 0 : _this$articles$get17.bodyContent) || 'Loading content...', this.closeDialog, this.closeDialog, this.openDialog, ((_this$articles$get18 = this.articles.get('seek')) === null || _this$articles$get18 === void 0 ? void 0 : _this$articles$get18.title) || 'Loading...', (_this$articles$get19 = this.articles.get('seek')) === null || _this$articles$get19 === void 0 ? void 0 : _this$articles$get19.title, ((_this$articles$get20 = this.articles.get('seek')) === null || _this$articles$get20 === void 0 ? void 0 : _this$articles$get20.bodyContent) || 'Loading content...', this.closeDialog, this.closeDialog, this.openDialog, ((_this$articles$get21 = this.articles.get('questions')) === null || _this$articles$get21 === void 0 ? void 0 : _this$articles$get21.title) || 'Loading...', (_this$articles$get22 = this.articles.get('questions')) === null || _this$articles$get22 === void 0 ? void 0 : _this$articles$get22.title, ((_this$articles$get23 = this.articles.get('questions')) === null || _this$articles$get23 === void 0 ? void 0 : _this$articles$get23.bodyContent) || 'Loading content...', this.closeDialog, this.closeDialog, this.openDialog, ((_this$articles$get24 = this.articles.get('why_anxiety')) === null || _this$articles$get24 === void 0 ? void 0 : _this$articles$get24.title) || 'Loading...', (_this$articles$get25 = this.articles.get('why_anxiety')) === null || _this$articles$get25 === void 0 ? void 0 : _this$articles$get25.title, ((_this$articles$get26 = this.articles.get('why_anxiety')) === null || _this$articles$get26 === void 0 ? void 0 : _this$articles$get26.bodyContent) || 'Loading content...', this.closeDialog, this.closeDialog, this.openDialog, ((_this$articles$get27 = this.articles.get('deal_anxiety')) === null || _this$articles$get27 === void 0 ? void 0 : _this$articles$get27.title) || 'Loading...', (_this$articles$get28 = this.articles.get('deal_anxiety')) === null || _this$articles$get28 === void 0 ? void 0 : _this$articles$get28.title, ((_this$articles$get29 = this.articles.get('deal_anxiety')) === null || _this$articles$get29 === void 0 ? void 0 : _this$articles$get29.bodyContent) || 'Loading content...', this.closeDialog, this.closeDialog, this.openDialog, ((_this$articles$get30 = this.articles.get('signs_anxiety')) === null || _this$articles$get30 === void 0 ? void 0 : _this$articles$get30.title) || 'Loading...', (_this$articles$get31 = this.articles.get('signs_anxiety')) === null || _this$articles$get31 === void 0 ? void 0 : _this$articles$get31.title, ((_this$articles$get32 = this.articles.get('signs_anxiety')) === null || _this$articles$get32 === void 0 ? void 0 : _this$articles$get32.bodyContent) || 'Loading content...', this.closeDialog, this.closeDialog, this.openDialog, ((_this$articles$get33 = this.articles.get('triggers_anxiety')) === null || _this$articles$get33 === void 0 ? void 0 : _this$articles$get33.title) || 'Loading...', (_this$articles$get34 = this.articles.get('triggers_anxiety')) === null || _this$articles$get34 === void 0 ? void 0 : _this$articles$get34.title, ((_this$articles$get35 = this.articles.get('triggers_anxiety')) === null || _this$articles$get35 === void 0 ? void 0 : _this$articles$get35.bodyContent) || 'Loading content...', this.closeDialog, this.closeDialog, this.openDialog, ((_this$articles$get36 = this.articles.get('practices_anxiety')) === null || _this$articles$get36 === void 0 ? void 0 : _this$articles$get36.title) || 'Loading...', (_this$articles$get37 = this.articles.get('practices_anxiety')) === null || _this$articles$get37 === void 0 ? void 0 : _this$articles$get37.title, ((_this$articles$get38 = this.articles.get('practices_anxiety')) === null || _this$articles$get38 === void 0 ? void 0 : _this$articles$get38.bodyContent) || 'Loading content...', this.closeDialog, this.closeDialog, this.openDialog, ((_this$articles$get39 = this.articles.get('seek_anxiety')) === null || _this$articles$get39 === void 0 ? void 0 : _this$articles$get39.title) || 'Loading...', (_this$articles$get40 = this.articles.get('seek_anxiety')) === null || _this$articles$get40 === void 0 ? void 0 : _this$articles$get40.title, ((_this$articles$get41 = this.articles.get('see_anxiety')) === null || _this$articles$get41 === void 0 ? void 0 : _this$articles$get41.bodyContent) || 'Loading content...', this.closeDialog, this.closeDialog, this.openDialog, ((_this$articles$get42 = this.articles.get('questions_anxiety')) === null || _this$articles$get42 === void 0 ? void 0 : _this$articles$get42.title) || 'Loading...', (_this$articles$get43 = this.articles.get('questions_anxiety')) === null || _this$articles$get43 === void 0 ? void 0 : _this$articles$get43.title, ((_this$articles$get44 = this.articles.get('questions_anxiety')) === null || _this$articles$get44 === void 0 ? void 0 : _this$articles$get44.bodyContent) || 'Loading content...', this.closeDialog, this.closeDialog, this.openDialog, ((_this$articles$get45 = this.articles.get('why_depression')) === null || _this$articles$get45 === void 0 ? void 0 : _this$articles$get45.title) || 'Loading...', (_this$articles$get46 = this.articles.get('why_depression')) === null || _this$articles$get46 === void 0 ? void 0 : _this$articles$get46.title, ((_this$articles$get47 = this.articles.get('why_depression')) === null || _this$articles$get47 === void 0 ? void 0 : _this$articles$get47.bodyContent) || 'Loading content...', this.closeDialog, this.closeDialog, this.openDialog, ((_this$articles$get48 = this.articles.get('deal_depression')) === null || _this$articles$get48 === void 0 ? void 0 : _this$articles$get48.title) || 'Loading...', (_this$articles$get49 = this.articles.get('deal_depression')) === null || _this$articles$get49 === void 0 ? void 0 : _this$articles$get49.title, ((_this$articles$get50 = this.articles.get('deal_depression')) === null || _this$articles$get50 === void 0 ? void 0 : _this$articles$get50.bodyContent) || 'Loading content...', this.closeDialog, this.closeDialog, this.openDialog, ((_this$articles$get51 = this.articles.get('signs_depression')) === null || _this$articles$get51 === void 0 ? void 0 : _this$articles$get51.title) || 'Loading...', (_this$articles$get52 = this.articles.get('signs_depression')) === null || _this$articles$get52 === void 0 ? void 0 : _this$articles$get52.title, ((_this$articles$get53 = this.articles.get('signs_depression')) === null || _this$articles$get53 === void 0 ? void 0 : _this$articles$get53.bodyContent) || 'Loading content...', this.closeDialog, this.closeDialog, this.openDialog, ((_this$articles$get54 = this.articles.get('triggers_depression')) === null || _this$articles$get54 === void 0 ? void 0 : _this$articles$get54.title) || 'Loading...', (_this$articles$get55 = this.articles.get('triggers_depression')) === null || _this$articles$get55 === void 0 ? void 0 : _this$articles$get55.title, ((_this$articles$get56 = this.articles.get('triggers_depression')) === null || _this$articles$get56 === void 0 ? void 0 : _this$articles$get56.bodyContent) || 'Loading content...', this.closeDialog, this.closeDialog, this.openDialog, ((_this$articles$get57 = this.articles.get('practices_depression')) === null || _this$articles$get57 === void 0 ? void 0 : _this$articles$get57.title) || 'Loading...', (_this$articles$get58 = this.articles.get('practices_depression')) === null || _this$articles$get58 === void 0 ? void 0 : _this$articles$get58.title, ((_this$articles$get59 = this.articles.get('practices_depression')) === null || _this$articles$get59 === void 0 ? void 0 : _this$articles$get59.bodyContent) || 'Loading content...', this.closeDialog, this.closeDialog, this.openDialog, ((_this$articles$get60 = this.articles.get('seek_depression')) === null || _this$articles$get60 === void 0 ? void 0 : _this$articles$get60.title) || 'Loading...', (_this$articles$get61 = this.articles.get('seek_depression')) === null || _this$articles$get61 === void 0 ? void 0 : _this$articles$get61.title, ((_this$articles$get62 = this.articles.get('seek_depression')) === null || _this$articles$get62 === void 0 ? void 0 : _this$articles$get62.bodyContent) || 'Loading content...', this.closeDialog, this.closeDialog, this.openDialog, ((_this$articles$get63 = this.articles.get('questions_depression')) === null || _this$articles$get63 === void 0 ? void 0 : _this$articles$get63.title) || 'Loading...', (_this$articles$get64 = this.articles.get('questions_depression')) === null || _this$articles$get64 === void 0 ? void 0 : _this$articles$get64.title, ((_this$articles$get65 = this.articles.get('questions_depression')) === null || _this$articles$get65 === void 0 ? void 0 : _this$articles$get65.bodyContent) || 'Loading content...', this.closeDialog, this.closeDialog);
    (0, _litHtml.render)(template, _App.default.rootEl);
  }
}
